// most of this code borrowed from: https://gist.github.com/phi-lira/225cd7c5e8545be602dca4eb5ed111ba

// When creating shaders for Universal Render Pipeline you can you the ShaderGraph which is super AWESOME!
// However, if you want to author shaders in shading language you can use this teamplate as a base.
// Please note, this shader does not necessarily match perfomance of the built-in URP Lit shader.
// This shader works with URP 7.1.x and above
Shader "LowkeyShadersURP/Lit/NoFogLit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                //float fogFactor = input.positionWSAndFogFactor.w; // modified by @mateuszbudny

                // Mix the pixel color with fogColor. You can optionaly use MixFogColor to override the fogColor
                // with a custom one.
                //color = MixFog(color, fogFactor); // modified by @mateuszbudny
